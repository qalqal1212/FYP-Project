...
class _UpdateProfilePageState extends State<UpdateProfilePage> {
  ...
  Future profileGet() async {
    String url = "http://10.0.2.2/fyp_project_api_version_1.0/api/profile/profilesingle.php?userid=" + userid;
                              ...
                              children: <Widget>[
                               ...
                               MaterialButton(
                                 onPressed: () async {
                                  ...
                                  if (form.validate()) {
                                    form.save();
                                    String url = "http://10.0.2.2/fyp_project_api_version_1.0/api/profile/profileupdate.php?userid=" +
                                    userid +
                                    "&email=" +
                                    holdEmail +
                                    "&password=" +
